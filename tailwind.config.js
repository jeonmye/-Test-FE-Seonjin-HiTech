  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        headL: ['32px', { fontWeight: '500', lineHeight: '33px' }],
        'headL-bold': ['32px', { fontWeight: '700', lineHeight: '33px' }],
        headXL: ['38px', { fontWeight: '500', lineHeight: '33px' }],
        'headXL-bold': ['38px', { fontWeight: '700', lineHeight: '33px' }],
